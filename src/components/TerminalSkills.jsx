  ...
  return (
    <div className="w-full rounded-2xl overflow-hidden shadow-2xl border border-stone-200/50 dark:border-stone-800/50 bg-stone-50 dark:bg-[#0a0a08] flex flex-col md:flex-row reveal">
      ...
      <div className="w-full md:w-2/3 flex flex-col bg-[#1e1e1e] text-[#d4d4d4] min-h-[400px]">
        ...
        {/* Status Bar */}
        <div className="bg-[#007acc] text-[#ffffff] text-[11px] px-3 py-1 flex justify-between items-center font-mono">
          <div className="flex gap-4 items-center">
            <span className="flex items-center gap-1 hover:bg-[#ffffff]/10 px-1.5 py-0.5 rounded cursor-pointer transition-colors">
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
              main*
            </span>
            <span className="hidden sm:flex hover:bg-[#ffffff]/10 px-1.5 py-0.5 rounded cursor-pointer transition-colors">UTF-8</span>
            <span className="hidden md:flex hover:bg-[#ffffff]/10 px-1.5 py-0.5 rounded cursor-pointer transition-colors">Prettier</span>
          </div>
          <div className="flex gap-4 items-center">
            <span className="hidden sm:flex hover:bg-[#ffffff]/10 px-1.5 py-0.5 rounded cursor-pointer transition-colors">Ln {displayedText.split('\\n').length}, Col {displayedText.split('\\n').pop().length + 1}</span>
            <span className="flex items-center gap-1.5 hover:bg-[#ffffff]/10 px-1.5 py-0.5 rounded cursor-pointer transition-colors">
