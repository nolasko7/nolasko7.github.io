      ...
      <div className="max-w-[900px] mx-auto w-full flex-grow flex flex-col justify-center">
        <div className="mb-24 reveal">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {/* Email */}
            <a href={`mailto:${personalInfo.email}`} className="group flex items-center justify-between border border-stone-800 bg-stone-900/50 hover:border-green-500 p-6 rounded-xl transition-colors">
